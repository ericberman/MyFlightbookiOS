...
-(void)decodeTag:(NSMutableDictionary*) keyedValues : (NSNumber*) tagId : (CFDataRef*) tagData : (BOOL) bigEndianOrder{
    ...
    if (encoding != 0){
        ...
        NSString* string =[EXFUtils createStringFromBuffer:&start_ptr: (UInt32)length-8:encoding];
        // Debug(@"Got String in text field %@", string);
        keyedValues[tagId] = string;
    }
...
-(void)encodeTag: (NSMutableData*) targetBuffer : (id) tagData :(BOOL) bigEndianOrder{
    // tag data is an array of NSNumber
    NSInteger length = [((NSString*)tagData) lengthOfBytesUsingEncoding:NSASCIIStringEncoding];
...
-(int) getSizeOfValue:(id)value{
    ...
    if ([value isKindOfClass:[NSString class]]){
        ...
        return (int) [((NSString*)value) lengthOfBytesUsingEncoding:NSASCIIStringEncoding] +8;
    }
    return -1;
...
-(void)decodeTag:(NSMutableDictionary*) keyedValues : (NSNumber*) tagId : (CFDataRef*) tagData : (BOOL) bigEndianOrder{
    ...
    NSString* value = [EXFUtils createStringFromBuffer:&ptr: (UInt32) byteLength: NSASCIIStringEncoding];
    // Debug(@"Assigned string %@",value);
    
    keyedValues[tagId] = value;
}

-(void)encodeTag: (NSMutableData*) targetBuffer : (id) tagData :(BOOL) bigEndianOrder{
    // tag data is an array of NSNumber
    NSUInteger length = [((NSString*)tagData) lengthOfBytesUsingEncoding:NSASCIIStringEncoding];
    const char* cString = [((NSString*)tagData) cStringUsingEncoding:NSASCIIStringEncoding];
    [targetBuffer appendBytes: cString length:length];
...
-(int) getSizeOfValue:(id)value{
    ...
    if ([value isKindOfClass:[NSString class]]){
        ...
        return (int) [((NSString*)value) lengthOfBytesUsingEncoding:NSASCIIStringEncoding];
    }else{
        return -1;
    }
}
...
-(int) getSizeOfValue:(id)value{
    ...
    if ([value isKindOfClass:[NSArray class]]){
        ...
        return (int) [((NSArray*)value) count];
    }else{
        return -1;
    }
}
