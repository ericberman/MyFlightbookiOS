...
*/
-(instancetype) initWith: (long) numerator : (long) denominator NS_DESIGNATED_INITIALIZER;
...
-(instancetype) initWith: (EXFTagId) aTagId : (EXFDataType)aDataType : (NSString*) aName : (int) parentTagId : (BOOL)editable : (int) components NS_DESIGNATED_INITIALIZER;
