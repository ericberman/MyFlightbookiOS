...
@objc class BESessionController: NSObject, EAAccessoryDelegate, StreamDelegate {

    @objc static let sharedController = BESessionController()
    ...
    @objc func dataAsString() -> NSString? {
    ...
    @objc func writeData(data: NSData) {
        if _writeData == nil {
    ...
    @objc func readData(bytesToRead: Int) -> NSData {
